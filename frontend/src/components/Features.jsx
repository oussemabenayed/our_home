  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="bg-blue-50 text-blue-600 px-4 py-1.5 rounded-full text-sm font-medium tracking-wide uppercase">{t('features.our_strengths')}</span>
          <h2 className="text-4xl font-bold text-gray-900 mt-4 mb-4">{t('features.why_choose_us')}</h2>
