...
import { Loader, UserPlus, Mail, Lock, Phone } from 'lucide-react';
      ...
      >
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 mt-14">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="mt-6 text-2xl font-semibold text-gray-800">{t('auth.create_account')}</h2>
            <p className="mt-2 text-gray-600">{t('auth.join_community')}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">{t('auth.already_have_account')}</span>
              </div>
            </div>
