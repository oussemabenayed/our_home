  ...
  return (
    ...
    >
      ...
      <div className="mt-8 flex items-center">
        ...
        <div className="ml-4">
          {/* Client info */}
          <h3 className="font-bold text-gray-900 text-lg">{t(testimonial.nameKey)}</h3>
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-blue-600 font-semibold tracking-wider text-sm uppercase">{t('testimonials.title')}</span>
          <h2 className="text-4xl font-bold text-gray-900 mt-2 mb-4">{t('testimonials.heading')}</h2>
