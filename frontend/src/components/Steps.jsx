...
function Step({ icon: Icon, titleKey, descriptionKey, stepNumber, t }) {
  return (
    <motion.div 
    ...
    >
      ...
      <p className="text-gray-600 max-w-xs text-center leading-relaxed">{t(descriptionKey)}</p>
  ...
  return (
    <section className="py-28 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="bg-blue-50 text-blue-600 px-4 py-1.5 rounded-full text-sm font-medium tracking-wide uppercase">{t('steps.simple_process')}</span>
          <h2 className="text-4xl font-bold text-gray-900 mt-4 mb-4">{t('steps.how_it_works')}</h2>
        ...
        >
          <div className="bg-white p-8 rounded-xl shadow-xl border border-gray-50 text-center">
            <p className="text-gray-700 italic text-lg mb-4">
              {t('steps.testimonial_quote')}
            </p>
            <p className="font-bold text-gray-900">{t('steps.testimonial_author')}</p>
