...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(t('auth.reset_link_failed'));
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-semibold text-gray-800">{t('auth.forgot_password_title')}</h2>
            <p className="mt-2 text-gray-600">{t('auth.forgot_password_subtitle')}</p>
          </div>
